...
SWE::AbstractMySWESolver_ADERDG::AbstractMySWESolver_ADERDG(
  ...
  weights                       = kernels::legendre::weights;
  nodes                         = kernels::legendre::nodes;
  Kxi                           = kernels::legendre::Kxi;
  dudx                          = kernels::legendre::dudx;
  iK1                           = kernels::legendre::iK1;
  equidistantGridProjector      = kernels::legendre::equidistantGridProjector;
  FCoeff                        = kernels::legendre::FCoeff;
  fineGridProjector             = kernels::legendre::fineGridProjector;
  basisFunction                 = kernels::legendre::basisFunction;
  basisFunctionFirstDerivative  = kernels::legendre::basisFunctionFirstDerivative;
  basisFunctionSecondDerivative = kernels::legendre::basisFunctionSecondDerivative;
}
...
int SWE::AbstractMySWESolver_ADERDG::fusedSpaceTimePredictorVolumeIntegral(double* lduh, double* lQhbnd, double* lGradQhbnd, double* lFhbnd, double* const luh, const tarch::la::Vector<DIMENSIONS, double>& cellCentre, const tarch::la::Vector<DIMENSIONS, double>& cellSize, const double t ,const double dt,const bool addVolumeIntegralResultToUpdate) {
  ...
  if ( addVolumeIntegralResultToUpdate ) {
    kernels::aderdg::generic::c::volumeIntegralNonlinear<MySWESolver_ADERDG, true, true, false, NumberOfVariables, Order+1>(*static_cast<MySWESolver_ADERDG*>(this),lduh,lFhi,cellSize); 
  } else { // directly add the result to the solution
    double tempUpdate[NumberOfVariables*spaceBasisSize] = {0.0};
    kernels::aderdg::generic::c::volumeIntegralNonlinear<MySWESolver_ADERDG, true, true, false, NumberOfVariables, Order+1>(*static_cast<MySWESolver_ADERDG*>(this),tempUpdate,lFhi,cellSize);
...
void SWE::AbstractMySWESolver_ADERDG::faceIntegral(double* const out/*may be solution or update vector*/,double* const lFhbnd,const int direction, const int orientation,const tarch::la::Vector<DIMENSIONS-1,int>& subfaceIndex,const int levelDelta,const tarch::la::Vector<DIMENSIONS, double>& cellSize,const double dt,const bool addToUpdate) {
  ...
  if ( levelDelta > 0 ) {
    ...
    kernels::aderdg::generic::c::faceUnknownsRestriction<MySWESolver_ADERDG,NumberOfVariables,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),lFhbndCoarse,lFhbnd,subfaceIndex,levelDelta);
    tarch::la::Vector<DIMENSIONS,double> coarseGridCellSize = tarch::la::aPowI(levelDelta,3) * 1.0 * cellSize;
    
    kernels::aderdg::generic::c::faceIntegralNonlinear<MySWESolver_ADERDG,NumberOfVariables,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),out,lFhbndCoarse,direction,orientation,coarseGridCellSize);
  } else {
    if ( addToUpdate ) {
      kernels::aderdg::generic::c::faceIntegralNonlinear<MySWESolver_ADERDG,NumberOfVariables,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),out,lFhbnd,direction,orientation,cellSize);
      ...
      kernels::aderdg::generic::c::faceIntegralNonlinear<MySWESolver_ADERDG,NumberOfVariables,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),lduh,lFhbnd,direction,orientation,cellSize);
...
void SWE::AbstractMySWESolver_ADERDG::faceUnknownsProlongation(double* const lQhbndFine,double* const lFhbndFine,const double* const lQhbndCoarse,const double* const lFhbndCoarse,const int coarseGridLevel,const int fineGridLevel,const tarch::la::Vector<DIMENSIONS-1,int>& subfaceIndex) {
  kernels::aderdg::generic::c::faceUnknownsProlongation<MySWESolver_ADERDG,NumberOfVariables,NumberOfParameters,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),lQhbndFine,lFhbndFine,lQhbndCoarse,lFhbndCoarse,coarseGridLevel,fineGridLevel,subfaceIndex);
}
...
void SWE::AbstractMySWESolver_ADERDG::volumeUnknownsProlongation(double* const luhFine,const double* const luhCoarse,const int coarseGridLevel,const int fineGridLevel,const tarch::la::Vector<DIMENSIONS,int>& subcellIndex) {
  kernels::aderdg::generic::c::volumeUnknownsProlongation<MySWESolver_ADERDG,NumberOfVariables,NumberOfParameters,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),luhFine,luhCoarse,coarseGridLevel,fineGridLevel,subcellIndex);
}
...
void SWE::AbstractMySWESolver_ADERDG::volumeUnknownsRestriction(double* const luhCoarse,const double* const luhFine,const int coarseGridLevel,const int fineGridLevel,const tarch::la::Vector<DIMENSIONS,int>& subcellIndex) {
  kernels::aderdg::generic::c::volumeUnknownsRestriction<MySWESolver_ADERDG,NumberOfVariables,NumberOfParameters,Order+1>(*static_cast<MySWESolver_ADERDG*>(this),luhCoarse,luhFine,coarseGridLevel,fineGridLevel,subcellIndex);
}

//--------


void SWE::AbstractMySWESolver_ADERDG::resetGlobalObservables(double* const globalObservables) {
}

void SWE::AbstractMySWESolver_ADERDG::updateGlobalObservables(
...
void SWE::AbstractMySWESolver_ADERDG::mergeGlobalObservables(double* const globalObservables,const double* const otherObservables) {
}

void SWE::AbstractMySWESolver_ADERDG::wrapUpGlobalObservables(double* const globalObservables) {
}
...
void SWE::AbstractMySWESolver_ADERDG::resetGlobalObservables(GlobalObservables& globalObservables) const {
...
void SWE::AbstractMySWESolver_ADERDG::mapGlobalObservables(
...
void SWE::AbstractMySWESolver_ADERDG::mergeGlobalObservables(
    GlobalObservables&         globalObservables,
...
void SWE::AbstractMySWESolver_ADERDG::wrapUpGlobalObservables(GlobalObservables& globalObservables) const {
