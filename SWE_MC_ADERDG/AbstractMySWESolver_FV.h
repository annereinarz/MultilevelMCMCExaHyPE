...
//   www.exahype.eu
// ========================
#ifndef __AbstractMySWESolver_FV_CLASS_HEADER__
#define __AbstractMySWESolver_FV_CLASS_HEADER__
...
namespace SWE{
  class AbstractMySWESolver_FV;
  class MySWESolver_FV;
}

class SWE::AbstractMySWESolver_FV : public exahype::solvers::FiniteVolumesSolver {
  public:
    ...
    static constexpr int PatchSize                 = 3;
...
#endif // __AbstractMySWESolver_FV_CLASS_HEADER__