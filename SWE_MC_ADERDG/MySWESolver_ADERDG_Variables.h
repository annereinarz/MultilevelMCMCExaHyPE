...
// =============================---==============
#ifndef __MySWESolver_ADERDG_Variables_CLASS_HEADER__
#define __MySWESolver_ADERDG_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
 ...
 **/
class SWE::AbstractMySWESolver_ADERDG::VariableShortcuts : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
public:
 ...
 **/
class SWE::AbstractMySWESolver_ADERDG::VariableMultiplicities : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class SWE::AbstractMySWESolver_ADERDG::VariableNames : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace SWE::MySWESolver_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       SWE::AbstractMySWESolver_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace SWE {
  namespace MySWESolver_ADERDG_Variables {
    namespace shortcuts {
      constexpr int h = 0;
      constexpr int hu = 1;
      constexpr int hv = 2;
  ...
  } // end of namespace SWE::MySWESolver_ADERDG_Variables 
...
class SWE::AbstractMySWESolver_ADERDG::ReadOnlyVariables : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
  private:
...
class SWE::AbstractMySWESolver_ADERDG::Variables : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 4;
...
class SWE::AbstractMySWESolver_ADERDG::Fluxes : public SWE::AbstractMySWESolver_ADERDG::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class SWE::AbstractMySWESolver_ADERDG::ReadOnlyGlobalObservables {
  private:
...
class SWE::AbstractMySWESolver_ADERDG::GlobalObservables {
  private:
