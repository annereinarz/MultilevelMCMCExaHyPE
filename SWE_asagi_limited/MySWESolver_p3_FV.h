#ifndef __MySWESolver_p3_FV_CLASS_HEADER__
#define __MySWESolver_p3_FV_CLASS_HEADER__
...
#include "AbstractMySWESolver_p3_FV.h"
...
namespace SWE{
  class MySWESolver_p3_FV;
}

class SWE::MySWESolver_p3_FV : public SWE::AbstractMySWESolver_p3_FV {
  private:
  ...
  public:
    MySWESolver_p3_FV(const double maximumMeshSize,const exahype::solvers::Solver::TimeStepping timeStepping);
    ...
    double riemannSolver(double* const fL, double* const fR, const double* const qL, const double* const qR, const double* QL, const double* QR, const double* cellSize, int direction) override;
...
#endif // __MySWESolver_p3_FV_CLASS_HEADER__
